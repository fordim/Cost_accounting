        ...
        <form name="FormAddOperation" method="POST">
            <div class="row">
                <div class="form-group col">
                    ...
                    <input type="text" name="month" class="form-control small" id="OperationMonth" maxlength="30" aria-describedby="MonthHelp" required readonly value="<?= $thisMonth; ?>">
            ...
            <div class="row">
                <div class="form-group col">
                    ...
                    <input type="number" name="profit" class="form-control small" id="OperationProfit" maxlength="30" aria-describedby="ProfitHelp" required readonly value="<?= $lastMonthProfit; ?>">
